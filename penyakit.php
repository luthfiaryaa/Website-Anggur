          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <left><a href="tambah_penyakit.php" class="btn btn-primary">+ &nbsp; Tambah Penyakit</a><left>
                <br/>
                  ...
                  <tr>
                      ...
                      <td>
              <a href="edit_penyakit.php?id_penyakit=<?php echo $row['id_penyakit']; ?>">Edit</a> |
              <a href="hapus_penyakit.php?id_penyakit=<?php echo $row['id_penyakit']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
                  </tr>
