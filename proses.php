  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="pemetaan" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">Pemetaan Awal<br></a>
          ...
          ?>
             ...
             <?php
                ...
                <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">X - Average Normalisasi<br></a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                <?php
    ...
    foreach($array_of_users_products_normalize as $product => $user_products){
        ...
        $array_of_users_products_square_and_square_roots[$product]['square_root'] = sqrt($sum);
                ...
                <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">Square + Square Roots<br></a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                <?php
    ...
    foreach($products as $product){
        ...
        $array_of_users_products_similarity_abs[$product]['sum'] = $sum;
                ...
                <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">Similarity<br></a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                <?php
        ...
        foreach($array_of_users_products_similarity as $key => $row){
                ...
                <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">Similarity ABS<br></a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                <?php
        ...
        foreach($array_of_users_products as $key => $row){
            ...
            if (isset($array_of_prediction_abs[$key]['total']))
                ...
                ?>
                  ...
                  <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">Prediksi Akhir</a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                <?php
    ...
    foreach($array_of_prediction as $key => $predict){
        ...
        $array_of_mae[$key] = ($abs/ (count($list_users) == 0 ? 1 : count($list_users)));
                ...
                ?>
                  ...
                  <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">MAE</a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                    <th>Nilai MAE</th>
                ...
                ?>
                  ...
                  <table id="normalisasi" class="table table-bordered table-hover">
                  <a style="font-weight: bold; font-size: 30px;">MAE DESC<br></a>
                  <thead>
                  <tr>
                    <th>Nama Penyakit</th>
                    <th>Nilai MAE</th>
    ...
    foreach($array_of_mae as $key => $row){
                          ...
                          <tr>
            <?php echo "<td><a href='solusi.php?id=$key'>".$key."</td>"; ?>
