          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <left><a style="margin-bottom: 10px;" href="tambah_detail.php" class="btn btn-primary">+ &nbsp; Tambah Data</a><left>
                <br/>
                  ...
                  <?php 
                      include('koneksi.php');
                      $sql="SELECT p.nama_penyakit, g.keterangan, d.id_diagnosa FROM tbl_penyakit p, tbl_gejala g, tbl_diagnosa d WHERE d.id_gejala=g.id_gejala AND p.id_penyakit = d.id_penyakit";
              ...
              <a href="hapus_detail.php?id_diagnosa=<?php echo $row['id_diagnosa']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
                  </tr>
