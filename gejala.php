          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <left><a href="tambah_gejala.php" class="btn btn-primary">+ &nbsp; Tambah gejala</a><left> 
                <br>
                  ...
                  <tr>
                     ...
                     <td>
              <a href="edit_gejala.php?id_gejala=<?php echo $row['id_gejala']; ?>" class="btn btn-dark">Edit </a> 
              <a href="hapus_gejala.php?id_gejala=<?php echo $row['id_gejala']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" class="btn btn-dark">Hapus</a>
          </td>
                  </tr>
