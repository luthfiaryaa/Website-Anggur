              ...
              <div class="card-body">
                ...
                <table id="" class="table table-bordered table-hover">
                  ...
                  <tr>
                      ...
                      <td style="text-align: center;"><img src="admin/gambar/<?php echo $hasil_penyakit['gambar']; ?>" style="width: 300px;"></td>
                      <td style="text-align: center;"><img src="admin/gambar/<?php echo $gejala['gambar']; ?>" style="width: 300px;"></td>                
                  </tr>
