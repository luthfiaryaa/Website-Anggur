...
<table>
  <tbody>                    
      ...
      $query= mysqli_query($conn, $sql);
          ...
          <img onclick="myFunc(this)" src="admin/gambar/<?php echo $hasil['gambar']; ?>" alt="<?php echo $hasil['keterangan']; ?>" style="max-width:180px;margin-left: 50px; margin-bottom:20px"></tr>
...
<table>
  <tbody>
      ...
      $query= mysqli_query($conn, $sql);
          ...
          <img onclick="myFunc(this)" src="admin/gambar/<?php echo $hasil['gambar']; ?>" alt="<?php echo $hasil['keterangan']; ?>" style="max-width:180px; margin-left: 50px; margin-bottom: 20px;">
